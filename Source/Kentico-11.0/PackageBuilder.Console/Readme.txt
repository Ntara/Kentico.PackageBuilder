...
To install 'Package Builder' for Kentico 11, run the following command in
...
https://docs.kentico.com/k11/custom-development/creating-custom-modules/creating-installation-packages-for-modules/example-creating-a-packageable-module
