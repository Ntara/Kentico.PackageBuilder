...
namespace CMS.Modules
{
    ...
    internal class InstallableModulesManager
    {
        ...
        public IEnumerable<BasicModuleInstallationMetaData> GetModulesToBeInstalled(InstallableModulesState state)
        {
            ...
            // Prevents re-installation of a module when one instance uninstall the module and another one has not up-to-date code base
        ...
        /// <exception cref="System.IO.InvalidDataException">Thrown when file name has not the expected format.</exception>
...
#pragma warning disable BH1014 // Do not use System.IO
                throw new System.IO.InvalidDataException("The module description meta file name '" + descriptionFileName + "' has an unexpected format. Expected format is '<name>_<version>.xml'.", ex);
